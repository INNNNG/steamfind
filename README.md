{
   ...
   "account_tracker_service_last_update": "13305619081939086",
   "alternate_error_pages": {
      "backup": true
   },
   "autocomplete": {
      "retention_policy_last_version": 13
   },
   "autofill": {
   ...
   "browser": {
      ...
      "show_skin_button": false,
      "show_tab_manager_button": false,
      "window_placement": {
         "bottom": 1030,
         "left": 10,
         "maximized": false,
   ...
   "default_search_provider": {
      "synced_guid": "485bf7d3-0215-45af-87dc-538868000021"
   },
   "default_search_provider_data": {
      "template_url_data": {
         "alternate_urls": [ "https://www.baidu.com/s?ie={inputEncoding}&wd={searchTerms}", "https://www.baidu.com/s?ie={inputEncoding}&word={searchTerms}", "https://www.baidu.com/{google:pathWildcard}/s?ie={inputEncoding}&word={searchTerms}" ],
         ...
         "suggestions_url": "https://suggestion.baidu.com/su?wd={searchTerms}&action=opensearch&ie={inputEncoding}",
   ...
   "domain_diversity": {
      "last_reporting_timestamp": "13305619082108689"
   },
   "download": {
   ...
   "extensions": {
      ...
      "settings": {
         "ahfgeienlihckogmohjhadlkjgocpleb": {
            ...
            "install_time": "13305619081690941",
            "location": 5,
            "manifest": {
               "app": {
                  "launch": {
                  ...
                  "urls": [ "https://chrome.google.com/webstore", "https://ext.chrome.360.cn", "https://ext.se.360.cn", "https://skin.chrome.360.cn", "http://chrome.360.cn/themes", "http://warn.se.360.cn" ]
               },
               "description": "在这里，您可以找到适用于 Chromium 的精彩应用、游戏、扩展程序和主题背景。",
               "icons": {
               ...
               "name": "Chrome 网上应用店",
               "permissions": [ "account360", "webstorePrivate", "management", "themes", "tabs", "usercenter", "system.cpu", "system.display", "system.memory", "system.network", "system.storage" ],
               "version": "0.2"
            },
            "page_ordinal": "n",
            "path": "Z:\\通用工具\\360极速浏览器\\360Chrome\\Chrome\\Application\\13.5.2022.0\\resources\\web_store",
            "preferences": {
         ...
         "eemcgdkfndhakfknompkggombfjjjeno": {
            "active_permissions": {
               "api": [ "bookmarks", "bookmarkManagerPrivate", "management", "metricsPrivate", "systemPrivate", "tabs" ],
            ...
            "install_time": "13305619081690207",
            "location": 5,
            "manifest": {
               "chrome_url_overrides": {
                  "bookmarks": "main.html"
            ...
            "path": "Z:\\通用工具\\360极速浏览器\\360Chrome\\Chrome\\Application\\13.5.2022.0\\resources\\bookmark_manager_360ee",
            "preferences": {
         ...
         "kmendfapggjehodndflmmgagdbamhnfd": {
            "active_permissions": {
               "api": [ "cryptotokenPrivate", "externally_connectable.all_urls", "tabs" ],
            ...
            "content_settings": [  ],
            "creation_flags": 1,
            "events": [ "runtime.onConnectExternal" ],
            "from_bookmark": false,
            "from_webstore": false,
            "incognito_content_settings": [  ],
            "incognito_preferences": {
            ...
            "manifest": {
               ...
               "permissions": [ "cryptotokenPrivate", "externally_connectable.all_urls", "tabs", "https://*/*", "http://*/*" ],
               "version": "0.9.74"
            },
            "path": "Z:\\通用工具\\360极速浏览器\\360Chrome\\Chrome\\Application\\13.5.2022.0\\resources\\cryptotoken",
            "preferences": {
         ...
         "mfehgcgbbipciphmccgaenjidiccnmng": {
            ...
            "install_time": "13305619081690622",
            "location": 5,
            "manifest": {
               "app": {
                  "launch": {
            ...
            "path": "Z:\\通用工具\\360极速浏览器\\360Chrome\\Chrome\\Application\\13.5.2022.0\\resources\\cloud_print",
            "preferences": {
         ...
         "mhjfbmdgcfjbbpaeojofohoefgiehjai": {
            "active_permissions": {
               "api": [ "contentSettings", "fileSystem", "fileSystem.write", "metricsPrivate", "resourcesPrivate" ],
            ...
            "install_time": "13305619081691250",
            "location": 5,
            "manifest": {
               ...
               "permissions": [ "chrome://resources/", "contentSettings", "metricsPrivate", "resourcesPrivate", {
                  "fileSystem": [ "write" ]
               } ],
               "version": "1"
            },
            "path": "Z:\\通用工具\\360极速浏览器\\360Chrome\\Chrome\\Application\\13.5.2022.0\\resources\\pdf",
            "preferences": {
   ...
   "google": {
      "services": {
         "signin_scoped_device_id": "11ecd5d9-a238-4e05-bc75-eb26d87e955a"
      }
   },
   ...
   "media": {
      "device_id_salt": "DFF482688D24E996E7684D5702C3BDBF",
      "engagement": {
         "schema_version": 4
      }
   },
   "media_router": {
      "receiver_id_hash_token": "HNOFYbXHK93qQmfP6W5PYh4Z4TWZh9eLJuwSUjYomx/898kcHfDRURoH8nDSxlXZFsu8btcn1MvVhO86vUsLCQ=="
   },
   "ntp": {
   ...
   "plugins": {
      "npapi_flash_migrated_to_pepper_flash": true,
      "plugins_list": [  ]
   },
   "preset_popup_host_loaded": 3,
   "previews": {
      "litepage": {
   ...
   "profile": {
         ...
         "exceptions": {
            ...
            "media_engagement": {
               "https://www.baidu.com:443,*": {
                  "expiration": "0",
                  "last_modified": "13305619083867061",
                  "model": 0,
                  "setting": {
                     "hasHighScore": false,
            ...
            "popups": {
               "[*.]99bill.com,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685553",
                  "model": 0,
                  "setting": 1
               },
               "[*.]alipay.com,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685580",
                  "model": 0,
                  "setting": 1
               },
               "[*.]dangdang.com,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685592",
                  "model": 0,
                  "setting": 1
               },
               "[*.]ipos.10086.cn,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685536",
                  "model": 0,
                  "setting": 1
               },
               "[*.]netpay.sdo.com,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685520",
                  "model": 0,
                  "setting": 1
               },
               "[*.]pay.ips.com.cn,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685566",
                  "model": 0,
                  "setting": 1
               },
               "[*.]pay.soopay.net,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685559",
                  "model": 0,
                  "setting": 1
               },
               "[*.]payment.chinapnr.com,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685546",
                  "model": 0,
                  "setting": 1
               },
               "[*.]pingan.com,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685586",
                  "model": 0,
                  "setting": 1
               },
               "[*.]tenpay.com,*": {
                  "expiration": "0",
                  "last_modified": "13305619081685572",
                  "model": 0,
                  "setting": 1
               }
            },
            ...
            "site_engagement": {
               "https://www.baidu.com:443,*": {
                  "expiration": "0",
                  "last_modified": "13305619082010068",
                  "model": 0,
                  "setting": {
                     "lastEngagementTime": 1.330561908201006e+16,
                     "lastShortcutLaunchTime": 0.0,
                     "pointsAddedToday": 3.0,
                     "rawScore": 3.0
                  }
               },
               "https://www.so.com:443,*": {
                  "expiration": "0",
                  "last_modified": "13305619086655259",
                  "model": 0,
                  "setting": {
                     "lastEngagementTime": 1.3305619086655248e+16,
                     "lastShortcutLaunchTime": 0.0,
      ...
      "exited_cleanly": true,
      "icon_version": 6,
      "last_engagement_time": "13305619086655249",
      "managed_user_id": "",
      "name": "用户1",
      ...
      "switch_mode_type": 1,
      "use_native_zoom_level": true
   },
   "safemonLockHomePage": 0,
   "safemon_lock_search": 0,
   "se": {
      "browser": {
         "auto_popup_login_last_time": "23305616474920626",
         "close_last_tab_as_hao360": false,
         "close_last_tab_guide": false,
         "first_deal_bookmark": false,
         "introx64": {
            "count": 3,
            "enable": false,
            "version": 2
         },
         "login_wechat_tips": false,
         "new_tab": {
         ...
         "se9_import_type": 4,
         "toolbox_hide_status_bar_state": 1
      }
   },
   "show_360avatar": false,
   "show_addressbar_suggest": false,
   "show_search_hotspot": false,
   "show_selection_search_bar": false,
   "show_statusworld": false,
   "tab": {
      "close_last_tab_close_browser": false,
      "inactive_tab_hide_close_box": false
   },
   "translate": {
      "enabled": false
   },
   ...
   "web_apps": {
      ...
      "system_web_app_last_attempted_language": "zh-CN",
      "system_web_app_last_attempted_update": "13.5.2022.0",
      "system_web_app_last_installed_language": "zh-CN",
      "system_web_app_last_update": "13.5.2022.0",
      "user_display_mode_cleaned_up": false
   }
}
