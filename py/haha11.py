...
try:
    ...
    for row in c:
        ...
        aaaa='%s%s'%(aa,aaa)
        print aaaa
        kkk=("-B:%s%%20(%s)%%20%s%%%%20%s%%20-T:%s%%20(%s)%%20%s%%%%20%s"%(row[0],row[1],row[0]/(row[1]/100),rowd[0],row[2],row[3],row[2]/(row[3]/100),rowd[1]))
        print kkk
